        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="fh5co-right">
                        <small>
                            جميع حقوق الطبع محفوظة | <a href="about.php">أشرف بلعلي</a> | <a href="about.php">محمد
                                الوهابي</a> | <a href="index.php"> الرئيسية </a>&copy;
                        </small>
                    </p>
                </div>
            </div>
        ...
        <div class="row" style="margin-top: 15%;">
            <div class="col-lg-12">
                <img src="images/thanks.jpg"
                     title="نشكركم على ثقتكم بنا ستتوصلون ببريد إلكتروني قريبا لتأكيد استشهاركم"/>
            </div>
        </div>
    <?php
    }
