...
<div class="container">
    <div class="row">
        <div class="mybox col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-xs-12">
            <div class="row">
                <img
                    src="MODELE/resultat/<?php bye_XSS($donnees['id_publication']); ?>/<?php bye_XSS($donnees['id_resultat']); ?>.jpg"
                    class="col-md-12 col-lg-12 col-xs-12" title="<?php bye_XSS($donnees['titre_resultat']); ?>">
            </div>
            <div class="row">
            ...
            <div class="row">
                <center>
                    <p><a class="btn btn-lg btn-primary"
                          href="https://www.facebook.com/sharer/sharer.php?u=<?php //lien_à_partager
                          ?>" target="_blank" role="button">أنشر نتيجتك على الفيسبوك</a></p>
                </center>
            </div>
        </div>
    </div>
