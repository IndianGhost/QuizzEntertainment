        ...
        <div class="container">
            <div class="row row-bottom-padded-md">
                <div class="col-md-6 col-md-offset-3 text-center">
                    ...
                    <p class="fh5co-sub-lead animate-box">.استمتع باستخدام تطبيقاتنا المجانية و قم بإبهار أصدقائك على
                        مواقع التواصل الإجتماعي</p>
                </div>
            </div>
            <div class="row">
                <?php
                while ($donnees = $reponse->fetch()) {//Debut de la boucle de lecture de donnees
                ...
                */
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 animate-box">
                        ...
                        <a href="resultat.php?pub=<?php echo $id_publication; ?>&amp;rslt=<?php echo $resultat_aleatoire; ?>"
                           class="fh5co-project-item" target="_blank"> <!--class="image-popup"-->

                            <img width="717" height="475" src="MODELE/publication/<?php echo $id_publication; ?>.jpg"
                                 alt="<?php bye_XSS($donnees['titre_publication']); ?>" class="img-responsive">
