...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">&laquo;Cette plateforme vous offre la possibilitée d'<em>ajouter</em>, <em>modifier</em> et/ou
            <em>supprimer</em> n'importe quelle ligne dans les tables de votre <strong>base de données</strong> sans
            avoir à toucher le minimum du code&raquo;<br/>Bonne Continuation!</p>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p>En appuyant sur ce bouton, vous accèderez à une page d'insertion des publications et leurs
                résultats.<br/>Vous aurez besoin d'insérer des images, Faites attention à la taille demandée !</p>
            <p><a class="btn btn-primary" href="ajouter.php" role="button">Ajouter &raquo;</a></p>
        </div>
        <div class="col-lg-4">
            <h2>Modification</h2>
            <p>En appuyant sur ce bouton, vous accèderez à une page de modification des titres, descriptions ou même les
                images des publications et leurs résultats.<br/>Au cas de modification d'une image faites attention à la
                taille demandée!</p>
            <p><a class="btn btn-primary" href="modifier.php" role="button">Modifier &raquo;</a></p>
        </div>
        <div class="col-lg-4">
            <h2>Suppression</h2>
            <p>En appuyant sur ce bouton, vous accèderez à une page de suppression des publications et leurs
                résultats.<br/>La suppression d'une publication implique la suppression de tous ses résultats et le
                réciproque n'est pas forcément vrai!</p>
    ...
    <table id="divmsg" class="row">
        ...
        while ($donnees = $reponse->fetch()) {
            ...
            ?>
            <tr class="row">
                <td class="col-lg-4 col-xs-2"><?php bye_XSS($donnees['date_message_fr']); ?></td>
                <td class="col-lg-8 col-xs-10"><?php bye_XSS($donnees['contenu_message']); ?></td>
            </tr>
            <?php
        }//Fin de la boucle
