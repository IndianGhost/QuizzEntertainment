...
<body>
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">&laquo;<em>Supprimer</em> n'importe quelle tables de votre <strong>base de données</strong> sans avoir à toucher le minimum du code&raquo;<br>Bonne Continuation!</p>
      </div>
      <div class="row">
...
?>
          <tr class="row">
            <td class="col-xs-1">
              ...
              <div class="row">
                <a href="supprimer_pub.php?idpub=<?php bye_XSS($donnees['id_publication']);?>" title="Supprimer publication <?php bye_XSS($donnees['id_publication']);?>">
...
?>      <tr class="row">
            <td class="col-xs-1">          
              <div class="row">
                <a href="supprimer_result.php?idrslt=<?php bye_XSS($donnees['id_resultat']);?>" title="Supprimer résultat <?php bye_XSS($donnees['id_resultat']);?>">
                  <div class="col-lg-1 col-md-1 col-xs-1" >
                    <img src="../images/delete.png" width="10" length="10"/>
                  </div>
                </a>
