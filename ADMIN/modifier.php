...
<div class="container">
        ...
        <?php while ($donnees = $reponse_pub->fetch()) {//Affichage publication
            ...
            <tr class="row">
                <td class="col-xs-1">
                    ...
                    <div class="row">
                        <a href="modifier_pub.php?idpub=<?php bye_XSS($donnees['id_publication']); ?>"
                           title="Modifier publication <?php bye_XSS($donnees['id_publication']); ?>">
    ...
    <table class="row">
        ...
        <tr class="row">
            <td class="col-xs-1">
                <div class="row">
                    <a href="modifier_result.php?idrslt=<?php bye_XSS($donnees['id_resultat']); ?>"
                       title="Modifier résultat <?php bye_XSS($donnees['id_resultat']); ?>">
                        <div class="col-lg-1 col-md-1 col-xs-1">
                            <img src="../images/edit.png" width="10" length="10"/>
                        </div>
                    </a>
