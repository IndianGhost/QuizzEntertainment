			...
			<div class="container">
				<div class="row">
					...
					<div class="price-box">
						...
						<div class="price"><sup class="currency">$</sup>7<small>/شهر</small></div>
						<p>بلابلابلا </p>
						<hr>
				...
				<div class="col-md-3 col-sm-6 animate-box">
					<div class="price-box">
						...
						<div class="price"><sup class="currency">$</sup>19<small>/شهر</small></div>
						<p>بلا بلا بلا بلا</p>
						<hr>
						<ul class="pricing-info">
							<li>تفاصيل</li>
				...
				<div class="col-md-3 col-sm-6 animate-box">
					<div class="price-box popular">
						...
						<div class="price"><sup class="currency">$</sup>79<small>/شهر</small></div>
				...
				<div class="col-md-3 col-sm-6 animate-box">
					<div class="price-box">
						...
						<div class="price"><sup class="currency">$</sup>125<small>/شهر</small></div>
