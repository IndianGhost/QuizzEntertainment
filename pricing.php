...
<div id="fh5co-page">
        ...
        <div class="container">
            <nav role="navigation">
                <ul class="pull-left left-menu">
                    ...
                    <li><a href="pricing.php" class="actual_page">أعلن معنا</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="price-box">
                        <h2 class="pricing-plan">العرض 1</h2>
                        ...
                        <a href="publicite_formulaire.php" class="btn btn-default btn-sm popup-vimeo">أعلن الآن</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="price-box">
                        <h2 class="pricing-plan">العرض 2</h2>
                ...
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="price-box popular">
                        <div class="popular-text">العرض الأمثل</div>
                        <h2 class="pricing-plan">العرض 3</h2>
                        <div class="price"><sup class="currency">$</sup>79
                            <small>/شهر</small>
                        </div>
                        <p>بلابلابلا بلابلابلا بلابلابلا بلابلابلا</p>
                        <hr>
                        <ul class="pricing-info">
                            <li>تفاصيل</li>
                            <li>تفاصيل</li>
                ...
                <div class="col-md-3 col-sm-6 animate-box">
                    <div class="price-box">
                        <h2 class="pricing-plan">العرض 4</h2>
                        <div class="price"><sup class="currency">$</sup>125
                            <small>/شهر</small>
                        </div>
                        <p>بلابلابلا بلابلابلا بلابلابلا بلابلابلا بلابلابلا</p>
                        <hr>
                        <ul class="pricing-info">
                            <li>تفاصيل</li>
                            <li>تفاصيل</li>
    ...
    <section id="fh5co-subscribe">
        <div class="container">
            ...
            <form action="CONTROLEUR/traitement_msg.php?n=2" method="post" class="animate-box">
        ...
        <div class="fh5co-copyright animate-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="fh5co-right">
                            <small> جميع حقوق الطبع محفوظة | <a href="about.php">أشرف بلعلي</a> | <a href="about.php">محمد
